...
public class s3dStereoParametersEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        this.target.stereoReadoutText = (s3dGuiText) EditorGUILayout.ObjectField(new GUIContent("Stereo Readout Text", "Select s3dGuiText for Stereo Readout"), this.target.stereoReadoutText, typeof(s3dGuiText), allowSceneObjects, new GUILayoutOption[] {});
        ...
        {
            this.target.showStereoParamsTexture = (Texture2D) EditorGUILayout.ObjectField(new GUIContent("Show Params Texture", "Select Texture for Stereo Params Toggle"), this.target.showStereoParamsTexture, typeof(Texture), allowSceneObjects, new GUILayoutOption[] {});
            this.target.dismissStereoParamsTexture = (Texture2D) EditorGUILayout.ObjectField(new GUIContent("Dismiss Params Texture", "Select Texture for Dismiss Stereo Params Toggle"), this.target.dismissStereoParamsTexture, typeof(Texture), allowSceneObjects, new GUILayoutOption[] {});
        }
